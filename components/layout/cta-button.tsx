...
export const CTAButton = () => {
  return (
    <Link href="/contact">
      <button className="group bg-slate-800 no-underline group cursor-pointer relative shadow-lg drop-shadow-lg shadow-zinc-900 rounded-lg p-px text-xs font-workSans font-semibold leading-6  text-white inline-block">
