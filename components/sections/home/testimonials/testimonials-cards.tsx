        ...
        <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-2">
          {testimonials.map((t, i) => {
            ...
            return (
              <Card
                key={i}
                className="relative flex h-full flex-col bg-transparent shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] duration-300 dark:shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.2),0px_1px_0px_0px_rgba(255,255,255,0.05),0px_0px_0px_1px_rgba(255,255,255,0.1)]"
              >
